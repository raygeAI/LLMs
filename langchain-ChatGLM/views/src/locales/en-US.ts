export default {
  ...
  store: {
    ...
    addRepeatinstructionTips: 'instruction duplicate: {msg}, please re-enter',
    editRepeatTitleTips: 'Title conflict, please revise',
    editRepeatinstructionTips: 'instruction conflict {msg} , please re-modify',
    importError: 'Key value mismatch',
    importRepeatTitle: 'Title repeatedly skipped: {msg}',
    importRepeatinstruction: 'instruction is repeatedly skipped: {msg}',
